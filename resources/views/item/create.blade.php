    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-footer center">
                <button type="submit" class="btn btn-success">СОХРАНИТЬ ОСНОВНОЕ СРЕДСТВО</button> <a href="{{action('DocumentController@show',[$item->document_id])}}" class="btn btn-primary">ЗАКРЫТЬ БЕЗ СОХРАНЕНИЯ</a>
            </div><!-- /.box-footer -->
            {!!  Form::close() !!}
        </div>
    </section>
